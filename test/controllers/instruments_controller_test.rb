...
class InstrumentsControllerTest < ActionController::TestCase
  ...
  test "should create instrument" do
    assert_difference('Instrument.count') do
      post :create, instrument: { instrument_section_id: @instrument.instrument_section_id, name: @instrument.name }
    end
  ...
  test "should update instrument" do
    patch :update, id: @instrument, instrument: { instrument_section_id: @instrument.instrument_section_id, name: @instrument.name }
    assert_redirected_to instrument_path(assigns(:instrument))
  end

module ApplicationHelper
  ...
  def link_to_add_fields(name, f, association)
    ...
    # https://api.rubyonrails.org/ fields_for(record_name, record_object = nil,
    ...
    fields = f.fields_for(association, new_object, child_index: id) do |builder|
      # `association.to_s.singularize + "_fields"` ends up evaluating to
      # `address_fields`
      # The render function will then look for
      # `views/people/_address_fields.html.erb`
      # The render function also needs to be passed the value of 'builder',
      # because `views/people/_address_fields.html.erb` needs this to render the
      # form tags.
